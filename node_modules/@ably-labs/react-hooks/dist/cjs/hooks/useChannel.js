...
function useChannel(channelNameOrNameAndOptions, ...channelSubscriptionArguments) {
    const ably = typeof channelNameOrNameAndOptions === 'string'
        ? (0, AblyReactHooks_js_1.assertConfiguration)()
        : (channelNameOrNameAndOptions.realtime || (0, AblyReactHooks_js_1.assertConfiguration)());
    ...
    (0, react_1.useEffect)(useEffectHook, [channelName]);
    return [channel, ably];
}
